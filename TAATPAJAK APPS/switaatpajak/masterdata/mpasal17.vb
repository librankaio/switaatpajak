...
Public Class mpasal17
    ...
    Private Sub loaddata()
        txtlapis1fr.Text = cl.cCur(cl.readData("SELECT lapis1fr FROM mpasal17"))
        txtlapis1to.Text = cl.cCur(cl.readData("SELECT lapis1to FROM mpasal17"))
        txtlapis1trf.Text = cl.cCur(cl.readData("SELECT lapis1trf FROM mpasal17"))

        txtlapis2fr.Text = cl.cCur(cl.readData("SELECT lapis2fr FROM mpasal17"))
        txtlapis2to.Text = cl.cCur(cl.readData("SELECT lapis2to FROM mpasal17"))
        txtlapis2trf.Text = cl.cCur(cl.readData("SELECT lapis2trf FROM mpasal17"))

        txtlapis3fr.Text = cl.cCur(cl.readData("SELECT lapis3fr FROM mpasal17"))
        txtlapis3to.Text = cl.cCur(cl.readData("SELECT lapis3to FROM mpasal17"))
        txtlapis3trf.Text = cl.cCur(cl.readData("SELECT lapis3trf FROM mpasal17"))

        txtlapis4fr.Text = cl.cCur(cl.readData("SELECT lapis4fr FROM mpasal17"))
        txtlapis4trf.Text = cl.cCur(cl.readData("SELECT lapis4trf FROM mpasal17"))
    End Sub
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        With cl
            ...
            If btnsave.Text = "Save" Then
                ...
                If .readData("SELECT canadd from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'mpasal17'") = "N" Then
                ...
                If tny = vbYes Then
                    ...
                    .execCmdTrans(
                        ...
                        " , lapis3trf = '" & .cNum(txtlapis2trf.Text) & "'" &
                ...
                '    '----------USER AUTHORIZATION CHECK--------------'
                '    If .readData("SELECT canupdate from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'mpasal17'") = "N" Then
                '        .msgError("User tidak dapat melakukan tindakan ini ! Mohon untuk check setting otorisasi !", "Informasi")
                '        Exit Sub
                '    End If
                '    '---------------------END------------------------'
