...
Public Class Formulir1721_4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "taatpajak.Formulir1721-4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFormulir1721_4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Formulir1721_4 = New Formulir1721_4()
        rpt.Site = Me.Site
        Return rpt
    End Function
