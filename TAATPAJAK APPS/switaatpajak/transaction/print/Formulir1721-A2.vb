...
Public Class Formulir1721_A2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "taatpajak.Formulir1721-A2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFormulir1721_A2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Formulir1721_A2 = New Formulir1721_A2()
        rpt.Site = Me.Site
        Return rpt
    End Function
