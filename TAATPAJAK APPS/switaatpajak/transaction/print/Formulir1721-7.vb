...
Public Class Formulir1721_7
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "taatpajak.Formulir1721-7.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFormulir1721_7
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Formulir1721_7 = New Formulir1721_7()
        rpt.Site = Me.Site
        Return rpt
    End Function
