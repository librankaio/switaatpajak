...
Public Class Formulir1721_A1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "taatpajak.Formulir1721-A1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFormulir1721_A1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Formulir1721_A1 = New Formulir1721_A1()
        rpt.Site = Me.Site
        Return rpt
    End Function
