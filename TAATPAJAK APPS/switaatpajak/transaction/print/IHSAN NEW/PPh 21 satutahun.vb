...
Public Class PPh_21_satutahun
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "taatpajak.PPh 21 satutahun.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPPh_21_satutahun
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PPh_21_satutahun = New PPh_21_satutahun()
        rpt.Site = Me.Site
        Return rpt
    End Function
