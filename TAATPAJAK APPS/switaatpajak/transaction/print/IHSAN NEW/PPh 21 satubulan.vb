...
Public Class PPh_21_satubulan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "taatpajak.PPh 21 satubulan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPPh_21_satubulan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PPh_21_satubulan = New PPh_21_satubulan()
        rpt.Site = Me.Site
        Return rpt
    End Function
