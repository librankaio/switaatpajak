Public Class search
    ...
    Private Sub submitsearch()
        ...
        ElseIf statusTempForm = "[mnegara]mpenghasila1" Then
            ...
            End With
        ElseIf statusTempForm = "[mobjkpjk]mssp" Then
            Dim a As mssp = CType(Application.OpenForms("mssp"), mssp)
            a.Enabled = True

            With Me.dgview
                a.getidmaster(cl.cNum(.Item("id", i).Value))
                a.txtkdobj.Text = cl.cChr(.Item("kode", i).Value)
        ...
        ElseIf statusTempForm = "[mssp]mssp" Then
            ...
            With Me.dgview
                a.getidmaster(cl.cNum(.Item("id", i).Value))
                a.txtkdobj.Text = cl.cChr(.Item("kode", i).Value)
                a.txtkode.Text = cl.cChr(.Item("jenis", i).Value)
        ...
        ElseIf statusTempForm = "[msetmasa]msetmasa" Then
            ...
            With Me.dgview
                ...
                a.nudtahunpjk.Text = cl.cNum(.Item("thnpjk", i).Value)
                'a.cmbstatus.Text = cl.cChr(.Item("statpjk", i).Value)

                If cl.cChr(.Item("statpjk", i).Value) = "O" Then
                    a.cmbstatus.SelectedIndex = 0
                ElseIf cl.cChr(.Item("statpjk", i).Value) = "A"
                    a.cmbstatus.SelectedIndex = 1
                ElseIf cl.cChr(.Item("statpjk", i).Value) = "C"
                    a.cmbstatus.SelectedIndex = 2
                End If
            End With
            a.changestatform("upd")


        ElseIf statusTempForm = "[mpenghasil]tpph42" Then
        ...
        ElseIf statusTempForm = "[tinputssppbk21]tinputssppbk21" Then
            ...
            With Me.dgview
                ...
                a.txtpph.Text = cl.cCur(.Item("pph", i).Value)
        ...
        ElseIf statusTempForm = "[tinputssppbk42]tinputssppbk42" Then
            ...
            With Me.dgview
                ...
                a.txtpph.Text = cl.cCur(.Item("pph", i).Value)
                a.cmbket.Text = cl.cChr(.Item("ket", i).Value)
                a.cmbket.Text = cl.cNum(.Item("pembetulan", i).Value)
            End With
            a.changestatform("upd")
        ...
        ElseIf statusTempForm = "[mpenghasil]tbuktiptgtdkfinal" Then
            Dim a As tbuktiptgtdkfinal = CType(Application.OpenForms("tbuktiptgtdkfinal"), tbuktiptgtdkfinal)
            a.Enabled = True
        ...
        ElseIf statusTempForm = "[mpenghasil]tbuktiptgfinal" Then
            Dim a As tbuktiptgfinal = CType(Application.OpenForms("tbuktiptgfinal"), tbuktiptgfinal)
            a.Enabled = True
        ...
        ElseIf statusTempForm = "[tinputdatapemotongpjk]tinputdatapemotongpjk" Then
            ...
            With Me.dgview
                ...
                a.txtnpwp.Text = cl.cChr(.Item("npwp", i).Value)
                a.txtnama.Text = cl.cChr(.Item("nama", i).Value)
                a.cmbkodepjk.SelectedValue = cl.cChr(.Item("kodepjk", i).Value)
                ...
                a.cmbkdnegara_rl.SelectedValue = cl.cChr(.Item("kdnegara_rl", i).Value)
                If cl.cChr(.Item("wpasing", i).Value) = "Y" Then
                    a.chwpasing.Checked = True
                Else
                    a.chwpasing.Checked = False
        ...
        ElseIf statusTempForm = "[mpenghasila1]tpph21" Then
            ...
            With Me.dgview
                ...
                a.cmbstatus.Text = cl.cChr(.Item("status", i).Value)
                a.cmbname_mjabatan.Text = cl.cChr(.Item("name_mjabatan", i).Value)
                a.cmbtgngan.Text = cl.cChr(.Item("tanggungan", i).Value)
            End With
        ...
        ElseIf statusTempForm = "[mpenghasil]tpph23" Then
        ...
        ElseIf statusTempForm = "[tpph23]tpph23" Then
            ...
            With Me.dgview
                ...
                a.txtjmlbruto.Text = cl.cCur(.Item("jmlbruto", i).Value)
                a.txttrf.Text = cl.cCur(.Item("trf", i).Value)
                a.txtpphdipotong.Text = cl.cCur(.Item("pphdipotong", i).Value)
                a.txtnamaptg.Text = cl.cChr(.Item("namaptg", i).Value)
        ...
        ElseIf statusTempForm = "[tsptmasapphfinal42]tsptmasapphfinal42" Then
            ...
            With Me.dgview
                ...
                a.txth2pphptg15.Text = cl.cChr(.Item("h2pphptg15", i).Value)
        ...
        ElseIf statusTempForm = "[mobjkpjk]tpph23" Then
            ...
            End With
        ElseIf statusTempForm = "[mobjkpjkh]tbuktiptgtdkfinal" Then
            Dim a As tbuktiptgtdkfinal = CType(Application.OpenForms("tbuktiptgtdkfinal"), tbuktiptgtdkfinal)
            a.Enabled = True

            With Me.dgview
                '    a.getidmaster(cl.cNum(.Item("id", i).Value))
                a.txtobpjk.Text = cl.cChr(.Item("kode", i).Value)

            End With

        ElseIf statusTempForm = "[mobjkpjk]tbuktiptgtdkfinal" Then
            Dim a As tbuktiptgtdkfinal = CType(Application.OpenForms("tbuktiptgtdkfinal"), tbuktiptgtdkfinal)
            a.Enabled = True

            a.dgview.CurrentCell = a.dgview.Item("dpp", a.dgview.CurrentRow.Index)
            With Me.dgview
                a.dgview.Rows(a.dgview.CurrentRow.Index).Cells("kdobjpjk").Value = .Rows(i).Cells("kode").Value
                a.dgview.Rows(a.dgview.CurrentRow.Index).Cells("trf").Value = 0
                a.txtobpjk.Text = cl.cChr(.Item("kode", i).Value)
            End With

        ElseIf statusTempForm = "[mobjkpjk]tbuktiptgfinal" Then
            Dim a As tbuktiptgfinal = CType(Application.OpenForms("tbuktiptgfinal"), tbuktiptgfinal)
            a.Enabled = True

            a.dgview.CurrentCell = a.dgview.Item("bruto", a.dgview.CurrentRow.Index)

            With Me.dgview
                a.dgview.Rows(a.dgview.CurrentRow.Index).Cells("kdobjpjk").Value = .Rows(i).Cells("kode").Value
                a.dgview.Rows(a.dgview.CurrentRow.Index).Cells("trf").Value = 0
                a.txtobjpjk.Text = cl.cChr(.Item("kode", i).Value)
            End With
        ElseIf statusTempForm = "[mobjkpjkh]tbuktiptgfinal" Then
            Dim a As tbuktiptgfinal = CType(Application.OpenForms("tbuktiptgfinal"), tbuktiptgfinal)
            a.Enabled = True
        ...
        ElseIf statusTempForm = "[mobjkpjkh]tbuktiptgfinal" Then
            ...
            '    End With
        ElseIf statusTempForm = "[mpasal23]tpph23" Then
            Dim a As tpph23 = CType(Application.OpenForms("tpph23"), tpph23)
            a.Enabled = True

            With Me.dgview
                a.getidmaster(cl.cNum(.Item("id", i).Value))
                a.txttrf.Text = cl.cCur(.Item("tariff", i).Value)
                a.txturaian.Text = cl.cChr(.Item("dsc", i).Value)
            End With
            ...
            With Me.dgview
                ...
                For r As Integer = 0 To dtdet.Rows.Count - 1
                    ...
                    With dtdet
                        ...
                        a.dgview.Rows(rrowpl).Cells("kdobj").Value = .Rows(r).Item("uraian")
