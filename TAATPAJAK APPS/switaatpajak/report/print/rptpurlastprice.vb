...
Public Class rptpurlastprice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "taatpajak.rptpurlastprice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptpurlastprice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptpurlastprice = New rptpurlastprice()
        rpt.Site = Me.Site
        Return rpt
    End Function
